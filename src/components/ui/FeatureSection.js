...
const FeatureSection = () => {
  return (
    <div className='flex flex-col items-end rounded-2xl border-2 border-[#EFEBE7] my-8 mx-4 lg:flex-row lg:justify-between lg:mx-24'>
      ...
      <div className='px-8 pt-12 pb-8 w-full lg:pb-20 lg:px-10 lg:w-1/2'>
        ...
        <div className='my-12'>
          <p className='text-[22px] leading-normal lg:text-[32px]'>
        ...
        <div className='flex justify-end'>
          <Link
            href='/#'
            className='border-[1px] border-[#EABC4D] text-[#EABC4D] text-xl font-bold py-2 px-4 rounded-lg lg:text-4xl'
          >
            Empieza Ahora
          </Link>
        </div>
